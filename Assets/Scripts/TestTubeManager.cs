...
public class TestTubeManager : MonoBehaviour {
	...
	void Start () {
		...
		originalDoorPos = new Vector3 (-.5068f, -27.05f, -0.113f);
	}
	...
	void Update ()
	{
        ...
        if (knobRotation_1 > 0 && knobRotation_1 < 90) {
			if (myColor_1 != new Color (1f, 0f, 0f)) {
				if (!myAudioSource.isPlaying) {
					myAudioSource.clip = bubbles;
					myAudioSource.Play ();
				}
					CPuzzle_1 = false;
			...
			if (myColor_1 != new Color (0f, 0.089f, 1f)) {
				if (!myAudioSource.isPlaying) {
					myAudioSource.clip = bubbles;
					myAudioSource.Play ();
				}
			...
			if (myColor_1 != new Color (1f, 0f, 1f)) {
				if (!myAudioSource.isPlaying) {
					myAudioSource.clip = bubbles;
					myAudioSource.Play ();
				}
			...
			if (myColor_1 != new Color (0f, 1f, 1f)) {
				if (!myAudioSource.isPlaying) {
					myAudioSource.clip = bubbles;
					myAudioSource.Play ();
				}
		...
		if (knobRotation_2 > 0 && knobRotation_2 < 90) {
			if (myColor_2 != new Color (1f, 0f, 0f)) {
				if (!myAudioSource.isPlaying) {
					myAudioSource.clip = bubbles;
					myAudioSource.Play ();	
				}
			...
			if (myColor_2 != new Color (0f, 0.089f, 1f)) {
				if (!myAudioSource.isPlaying) {
					myAudioSource.clip = bubbles;
					myAudioSource.Play ();	
				}
			...
			if (myColor_2 != new Color (1f, 0f, 1f)) {
				if (!myAudioSource.isPlaying) {
					myAudioSource.clip = bubbles;
					myAudioSource.Play ();	
				}
			...
			if (myColor_2 != new Color (0f, 1f, 1f)) {
				if (!myAudioSource.isPlaying) {
					myAudioSource.clip = bubbles;
					myAudioSource.Play ();	
				}
		...
		if (knobRotation_3 > 0 && knobRotation_3 < 90) {
			if (myColor_3 != new Color (1f, 0f, 0f)) {
				if (!myAudioSource.isPlaying) {
					myAudioSource.clip = bubbles;
					myAudioSource.Play ();	
				}
			...
			if (myColor_3 != new Color (0f, 0.089f, 1f)) {
				if (!myAudioSource.isPlaying) {
					myAudioSource.clip = bubbles;
					myAudioSource.Play ();	
				}
			...
			if (myColor_3 != new Color (1f, 0f, 1f)) {
				if (!myAudioSource.isPlaying) {
					myAudioSource.clip = bubbles;
					myAudioSource.Play ();	
				}
			...
			if (myColor_3 != new Color (0f, 1f, 1f)) {
				if (!myAudioSource.isPlaying) {
					myAudioSource.clip = bubbles;
					myAudioSource.Play ();	
				}
